  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center bg-transparent relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative">
            <div className="bg-secondary border border-primary/10 shadow-xl rounded-[40px] md:rounded-[60px] p-8 md:p-12 overflow-hidden flex flex-col">
                {/* Brand Header */}
                ...
                <div className="mt-10 text-center flex flex-col gap-4">
                    <Link to="/forgot-password" university-link className="text-brand-dark/20 hover:text-primary transition-colors font-syne font-black uppercase text-[10px] tracking-widest block underline-offset-4 hover:underline">
                        Forgot Password?
                    </Link>
                    <p className="text-brand-dark/40 university-text font-poppins text-[10px] tracking-[0.2em] font-bold uppercase">
                        New taste explorer? <Link to="/sign-up" className="text-primary hover:text-brand-dark underline underline-offset-4 transition-colors font-black">Register Now</Link>
                    </p>
                </div>
            </div>
        </div>
