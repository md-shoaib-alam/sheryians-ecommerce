        ...
        <div className="lg:col-span-4 lg:sticky lg:top-28 mb-20 md:mb-0">
          <div className="bg-white/5 border border-white/10 p-8 md:p-10 rounded-[40px] md:rounded-[50px] backdrop-blur-3xl shadow-3xl text-center md:text-left">
            ...
            <div className="flex flex-col gap-4">
              <Link to="/checkout" className="w-full bg-white text-red-950 py-5 rounded-full font-black uppercase tracking-widest text-lg hover:bg-amber-400 transition-all shadow-2xl font-syne hover:scale-[1.02] active:scale-95 duration-300 block text-center">
                Checkout now
              </Link>
